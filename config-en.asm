...
DEF REV_TAUNT    EQU 1 ; If set, use the ridiculous taunt logic of the English version
DEF REV_LOGO_EN  EQU 1 ; Use Laguna logo and english-style copyright/logo changes.
DEF REV_LANG_EN  EQU 1 ; Use English text.
