...
.obj2:
	mMvC_ValNextFrameOnGtYSpeed -$02, ANIMSPEED_NONE, .doGravity
		...
		add  hl, bc
		res  PF1B_INVULN, [hl]
		mMvC_SetDamageNext $08, HITTYPE_LAUNCH_FAST_DB, PF3_CONTHIT
		jp   .doGravity
...
.obj4_cont:
	jp   .doGravityDamage
; --------------- frame #5 ---------------
; Deal large amounts of damage once, releasing the opponent with HITTYPE_LAUNCH_FAST_DB.
.obj5:
...
MoveC_Chizuru_ThrowG:
	...
	; Depending on the visible frame...
	mMvC_StartChkFrame
		mMvC_ChkFrame $00, .rotL
		mMvC_ChkFrame $01, .rotD
		mMvC_ChkFrame $02, .rotR
