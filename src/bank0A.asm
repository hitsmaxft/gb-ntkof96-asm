...
.chkGround:
	;             SELECT + B                               SELECT + A
	mMvIn_ChkEasyDir MoveInit_Goenitz_YonokazeNear, MoveInit_Goenitz_Hyouga, MoveInit_Goenitz_Yamidoukoku, MoveInit_Goenitz_YonokazeFar, MoveInit_Goenitz_WanpyouTokobuse, .startPunchSuper, MoveInputReader_Goenitz_NoMove
...
.obj3:
	mMvC_ValFrameStart .obj3_cont
		mMvC_SetDamageNext $02, HITTYPE_LAUNCH_SWOOPUP, PF3_HEAVYHIT
		call Play_Proj_CopyMoveDamageFromPl
...
MoveC_Goenitz_ShinyaotomeThrowL:
	...
	; Depending on the visible frame...
	mMvC_StartChkFrame
		mMvC_ChkFrame $00, .setSpeed06
		mMvC_ChkFrame $01, .rotU1
		mMvC_ChkFrame $02, .rotU2
		mMvC_ChkFrame $03, .rotL
		mMvC_ChkFrame $04, .rotD
...
MoveC_Goenitz_ShinyaotomeThrowH:
	...
	; Depending on the visible frame...
	mMvC_StartChkFrame
		mMvC_ChkFrame $00, .rotU1
		mMvC_ChkFrame $01, .rotU2
		mMvC_ChkFrame $02, .rotU3
		mMvC_ChkFrame $03, .rotU4Jump
		mMvC_ChkFrame $04, .rotDJump
		mMvC_ChkFrame $05, .setDamage
...
.doGravity:
	mMvC_ChkGravityHV $0060, .anim
		...
		mMvC_SetDamageNext $0A, HITTYPE_LAUNCH_FAST_DB, PF3_HEAVYHIT
		jp   .ret
; --------------- frame #6 ---------------
.chkEnd:
	mMvC_ValFrameEnd .anim
...
ProjC_Goenitz_WanpyouTokobuse:
	...
	add  hl, de
	ld   a, [hl]
		mMvC_ChkFrame $00, .objTopMid
		mMvC_ChkFrame $01, .objTopMid
		mMvC_ChkFrame $02, .objBottom
	jp   .anim ; We never get here
; --------------- frame #0-1 ---------------
; Top and mid frame.
